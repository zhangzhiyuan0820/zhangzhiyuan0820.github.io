...
新建完成后进入你的项目页面 点击`Settings`(设置) 位置在下图 红色圆圈圈住的地方 
...
点击左上角的加号 添加项目 有三个选项 点击`Clone` 如下图
...
前往 [官网](http://rubyinstaller.org/downloads/)
...
[Google一下](http://www.google.com/) 一大堆
随便下 一般都是这个格式 如下图:
...
后面的 [http://127.0.0.1:4000/](http://127.0.0.1:4000/)
